...
<head>
    ...
    <title>FruityThings - Update Product</title>
...
<div class="grid">
    ...
    <div class="formContainer f--jet">
        ...
        <form class="form" method="post" action="<?= APP_URL ?>actions/product-update.php" enctype="multipart/form-data" id="addProductForm">
            <label for="form" class="form-heading">Update Product</label>

            <input type="hidden" name="id" value="<?= $product->id ?>" />

            <label for="title" class="form-label"><strong>Title</strong></label>
            <div class="form-field">
                <input class="f--source" type="text" name="title" id="title" value="<?= old('title', $product->title) ?>"/>
                <span class="error"><?= error("title") ?></span>
            </div>

            <label for="description" class="form-label"><strong>Description</strong></label>
            <div class="form-field">
                <textarea class="f--source" name="description" id="description" rows="3"><?= old('description', $product->description) ?></textarea>
                <span class="error"><?= error("description") ?></span>
            </div>

            <label for="price" class="form-label"><strong>Price</strong></label>
            <div class="form-field">
                <input class="f--source" type="number" name="price" id="price" min="1" step="0.01" value="<?= old('price', $product->price) ?>"/>
                <span class="error"><?= error("price") ?></span>
            </div>

            <label for="age_rating" class="form-label"><strong>Age Rating </strong></label>
            <small>(was <?=$product->age_rating?>)</small>
            <div class="form-field">
            ...
            <small>(was <?=$product->average_rating?>)</small>
            <div class="form-field">
            ...
            <div class="form-field">
                <input class="f--source" type="date" name="release_date" id="release_date" value="<?= old('release_date', $product->release_date) ?>"/>
            ...
            <div class="form-group">
                <input class="f--source" type="checkbox" name="on_windows" id="on_windows" value="<?= old('on_windows', $product->on_windows) ?>"/>
                <span class="error"><?= error("on_windows") ?></span>
            </div>
            <label for="on_linux" class="form-label">Linux?</label>
            <div class="form-group">
                <input class="f--source" type="checkbox" name="on_linux" id="on_linux" value="<?= old('on_linux', $product->on_linux) ?>"/>
                <span class="error"><?= error("on_linux") ?></span>
            </div>
            <label for="on_mac" class="form-label">Mac?</label>
            <div class="form-group">
                <input class="f--source" type="checkbox" name="on_mac" id="on_mac" value="<?= old('on_mac', $product->on_mac) ?>"/>
                <span class="error"><?= error("on_mac") ?></span>
            </div>

            <label for="developer" class="form-label"><strong>Developer</strong></label>
            <div class="form-field">
                <input class="f--source" type="text" name="developer" id="developer" value="<?= old('developer', $product->developer) ?>"/>
                <span class="error"><?= error("developer") ?></span>
            </div>

            <label for="publisher" class="form-label"><strong>Publisher</strong></label>
            <div class="form-field">
                <input class="f--source" type="text" name="publisher" id="publisher" value="<?= old('publisher', $product->publisher) ?>"/>
                <span class="error"><?= error("publisher") ?></span>
            </div>

            <label for="genre_id" class="form-label"><strong>Genre </strong></label>
            <small>(was <?=$product->genre_id?>)</small>
            <div class="form-field">
